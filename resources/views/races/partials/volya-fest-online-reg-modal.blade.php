    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="section-title">РЕЄСТРАЦІЯ <span class="sub-title">«Воля.FEST.online»</span></h2>
                    ...
                    <div class="race-subtype-content">
                        <div class="online-subtype-wrapper">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="notes" id="" cols="30" rows="5" class="form-control" placeholder="Медаль отримаєте поштою, вкажіть будь ласка адресу доставки" required></textarea>
                            </div>
                        </div>
                    </div>
...
{{--                <div class="online-subtype-wrapper d-none">--}}
