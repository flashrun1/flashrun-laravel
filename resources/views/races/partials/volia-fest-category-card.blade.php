    ...
    <div class="categories-card">
        <div class="row">
            ...
            <div class="col-sm-7">
                ...
                <div class="descr custom-color">27.08.23 - забіг, який відбудеться в Лісогринівецькому лісі.</div>
                <button disabled type="button" class="btn" data-toggle="modal" data-target="#registr_modal-volyaFest">ЗАРЕЄСТРУВАТИСЬ</button>
