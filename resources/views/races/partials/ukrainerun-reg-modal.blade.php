<div class="modal fade" id="registr_modal5" tabindex="-1" aria-labelledby="registr_modal5" aria-modal="true"
     role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="section-title">РЕЄСТРАЦІЯ <span class="sub-title">«UkraineRUN»</span></h2>
                <h3 class="title">ПЛЯЖ/ПАРК ІМ.ЧЕКМАНА</h3>
            ...
            <div class="modal-body">
                ...
                <!--<div class="form-group prices my-4">
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="race_name" value="UkraineRUN">
                ...
                <div class="regular-subtype-wrapper d-none">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custon-radio-group">
                            <input id="registr_modal5_form_cb_option1" type="radio" name="distance" value="1000"  class="custon-radio-btn" checked>
                            <label for="registr_modal5_form_cb_option1">1 км</label>
