                    ...
                    <form method="post" action="{{ route('orders.store') }}" autocomplete="off"
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                ...
                                @endif
                                <div class="row">
                                    <label class="col-sm-2 col-form-label">{{ __('Ім\'я') }}</label>
                                    <div class="col-sm-7">
                                ...
                                <div class="row">
                                    <label class="col-sm-2 col-form-label">{{ __('Прізвище') }}</label>
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('surname') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('surname') ? ' is-invalid' : '' }}"
                                                   name="surname" id="input-surname" type="text"
                                                   placeholder="{{ __('Прізвище') }}"
                                                   value="" required
                                                   aria-required="true"/>
                                            @if ($errors->has('surname'))
                                                <span id="surname-error" class="error text-danger"
                                                      for="input-name">{{ $errors->first('surname') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <label class="col-sm-2 col-form-label">{{ __('Стать') }}</label>
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('sex') ? ' has-danger' : '' }}">
                                            <select id="input-sex" name="sex" required aria-required="true"
                                            ...
                                            @if ($errors->has('sex'))
                                                <span id="sex-error" class="error text-danger"
                                                      for="input-sex">{{ $errors->first('sex') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
